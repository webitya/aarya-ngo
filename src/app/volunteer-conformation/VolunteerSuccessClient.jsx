            ...
            <main className="max-w-2xl mx-auto">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600">
                        {isSuccess
                            ? `Congratulations ${volunteerDetails?.name || "Volunteer"}! Your application has been submitted successfully. Our team will review and approve soon.`
                            : "We could not verify your payment automatically. Please contact support."}
                    </p>
                </div>
                ...
                {isSuccess && (
                    <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            ...
                            className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold shadow-lg hover:shadow-xl"
                        ...
                        <Link
                            href="/"
                            className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold bg-white border border-gray-200 text-gray-600 hover:bg-gray-50"
                        >
