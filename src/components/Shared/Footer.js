      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="border-t border-white/10 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 gap-4">
          <div className="text-center md:text-left">
            ...
            <p className="mt-1">
              Designed and Maintained By <a href="https://webitya.com" target="_blank" rel="noopener noreferrer" className="hover:text-white/85 text-white transition-colors">Webitya</a>
            </p>
          </div>
